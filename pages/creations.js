                ...
                {memberDetails.map((card, i) => {
                  return (
                    <>
                      <div key={i}>
                        {card.Owner == Address && (
                          <div className="w-full shadow-md p-3 bg-gray-50 ">
                            <div className="flex flex-col">
                              ...
                              <div className="py-2 px-3 border-2 border-gray-500 h-auto mx-2 mt-4 rounded-lg">
                                <div className="grid grid-rows grid-flow-col gap-1  ">
                                  ...
                                  {card.IsDownloadable ? (
                                    <div className="row-start-2 row-span-2 flex items-center justify-center rounded-lg shadow py-2 hover:shadow-xl transition ease ">
                                      <a
