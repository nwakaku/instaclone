    ...
    <nav className="shadow-md fixed w-full z-50  ">
      <div className="flex items-center bg-white py-2 rounded-b-lg w-full">
        <div className="flex items items-center w-full mx-9 md:mx-40 justify-between">
          ...
          <form class="flex items-center text-gray-700 ">
            ...
            <div class="relative w-full">
              ...
              <input
                type="text"
                id="simple-search"
                class="bg-gray-10 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-200 dark:border-none dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search"
                required
              />
            </div>
